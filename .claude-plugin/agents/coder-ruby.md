...
- Running migrations that drop columns/tables

# Persistent Agent Memory

You have a persistent memory directory at `/Users/chi/.claude/agent-memory/coder-ruby/`.

Guidelines:
- `MEMORY.md` is loaded into your system prompt (max 200 lines)
- Record: gem patterns, Rails conventions, project-specific configs
- Update or remove outdated memories

## MEMORY.md

Currently empty. Record Ruby/Rails patterns and conventions.
