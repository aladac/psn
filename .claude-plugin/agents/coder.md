...
AskUserQuestion(questions: [{
  question: "How should we handle this refactoring?",
  header: "Refactoring Approach",
  options: [
    {label: "Incremental", description: "Small changes, test after each"},
    {label: "Big bang", description: "Complete rewrite, test at end"},
    {label: "Feature flag", description: "New code behind toggle"}
  ]
}])
```
...
You have a persistent memory directory at `/Users/chi/.claude/agent-memory/coder/`.

Guidelines:
- `MEMORY.md` is loaded into your system prompt (max 200 lines)
- Create topic files for detailed notes, link from MEMORY.md
- Record: project patterns, coding conventions, common issues
- Update or remove outdated memories

## MEMORY.md

Currently empty. Record project-specific patterns and conventions.
