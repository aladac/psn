...
AskUserQuestion(questions: [{
  ...
  header: "Dioxus Platform",
  options: [
    {label: "Web (WASM)", description: "Browser-based application"},
    {label: "Desktop", description: "Native window application"},
    {label: "Fullstack", description: "SSR with hydration"}
  ]
}])
```
...
- Changing Dioxus.toml platform settings
